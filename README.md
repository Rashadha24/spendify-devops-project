Spendify: Automated Expense Management System 👥 Group Information CRITICAL: All names and IDs match the LMS exactly to prevent an automatic zero grade.
...
📝 Project Description Spendify is a web-based financial tracking application designed for the "Systems Administration & Maintenance" module. It allows users to track daily expenses, manage tasks, and view spending history. The project focuses on a professional DevOps lifecycle, implementing automated CI/CD pipelines and a strict Git branching strategy.

🚀 Live Deployment 🔗 Live URL:https://spendify-devops-project.vercel.app 🛠 Technologies Used Frontend: HTML5, CSS3, JavaScript (ES6+)
...
✨ Features Expense Management: Add, delete, and track tasks.
...
🌿 Branch Strategy We implemented the following branching model as required:
...
🤝 Individual Contributions A.R.F.Rashatha (DevOps Engineer) Initialized the repository and configured branch protection rules.
...
U.Heerthana (Frontend Developer) Implemented UI/UX components and responsive styling.
...
⚙️ Setup Instructions Prerequisites Node.js (version 18 or higher)
...
🔄 Deployment Process The CI/CD pipeline is automated via GitHub Actions:
...
1.Build: docker build -t spendify .

2.Run: docker run -p 5173:5173 spendify
